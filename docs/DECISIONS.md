...
**D-028 (2026-09-06): Fluent divergence classification excludes the startup transient; C4 reported
...
(`make_figures._neural` now drops tagged runs), and Fig 11b was corrected to plot the cd_head error
against the cd_head conformal half-width (was cd_int).
