\begin{table}[t]
\centering
\caption{Surrogate vs Fluent on the accepted steady set (n=14, grid-converged at L2, GCI_fine CD(SA)=0.00%; qualitative external check). Surrogate CD is the input-robust coefficient head.}
\label{tab:fluent_verify}
\small
\begin{tabular}{llllllllllll}
\toprule
case & arm & NACA & Re & alpha & status & CD\_fl & CD\_fl-dbar & Transolver & SDF-FNO & GNN & cov90 (Transolver) \\
\midrule
