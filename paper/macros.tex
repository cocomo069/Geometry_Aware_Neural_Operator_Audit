...
% (../docs/05_geometry_aware_neural_operator_surrogate_uq.md). If a symbol changes
...
% REVTeX 4.2 already defines a \cp, so this one must override, not \newcommand.
\ifdefined\cp\renewcommand{\cp}{\ensuremath{c_p}}\else
  \newcommand{\cp}{\ensuremath{c_p}}\fi                   % surface pressure coefficient
